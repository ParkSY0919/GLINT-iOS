...
extension Color {
    ...
    static let gray0: Color = .init("#0B0B0B").opacity(0)
    static let gray15: Color = .init("#0B0B0B").opacity(0.15)
    static let gray30: Color = .init("#0B0B0B").opacity(0.30)
    static let gray45: Color = .init("#0B0B0B").opacity(0.45)
    static let gray60: Color = .init("#0B0B0B").opacity(0.60)
    static let gray75: Color = .init("#0B0B0B").opacity(0.75)
    static let gray90: Color = .init("#0B0B0B").opacity(0.90)
    static let gray100: Color = .init("#0B0B0B").opacity(1.0)
}
